...
__all__ = ['PAM_Module', 'CAM_Module','MAM_Module']
...
class MAM_Module(Module):
    ...
    def forward(self, x1, x2):
        ...
        proj_query2 = self.query_conv(x2).view(m_batchsize, -1, width*height).permute(0, 2, 1)
        proj_key2 = self.key_conv(x2).view(m_batchsize, -1, width*height)
        ...
        out = x2 + self.gamma*out2 + self.gamma*out1
        return out
